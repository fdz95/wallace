...
<html>
	<head>
		...
		<title>Wallace - Mas que un bar | Articulos</title>
	...
	<body class="hold-transition sidebar-mini layout-fixed">
									...
									<?php
										if($user_type == "ADMIN"){
											echo '<li class="nav-item"><a href="./index.php" class="nav-link"><i class="fas fa-utensils"></i>&nbsp;&nbsp;<p>Mesas</p></a></li>
												...
												<li class="nav-item"><a href="./articulos.php" class="nav-link active"><i class="fas fa-list-ul"></i>&nbsp;&nbsp;<p>Control de articulos</p></a></li>
			...
			<div class="content-wrapper">
				...
				<div class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1 class="m-0 text-dark">Control de articulos</h1>
							</div><!-- /.col -->
							<div class="col-sm-6">
								<ol class="breadcrumb float-sm-right">
									<li class="breadcrumb-item"><a href="#">Inicio</a></li>
									<li class="breadcrumb-item active">Control de articulos</li>
								</ol>
							</div><!-- /.col -->
						</div><!-- /.row -->
					</div><!-- /.container-fluid -->
									...
									<div class="card">
										<div class="card-header">
											<div class="input-group mb-3">
												<a href="#addArtModal" class="btn btn-info" data-toggle="modal"><b>+</b> Agregar articulo</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<a href="#addRubroModal" class="btn btn-success" data-toggle="modal"><b>+</b> Agregar rubro</a>&nbsp;&nbsp;&nbsp;
												<a href="#addSubrubroModal" class="btn btn-success" data-toggle="modal"><b>+</b> Agregar subrubro</a>
												<!--<input type="text" name="id_search_articulo" id="id_search_articulo" class="form-control rounded-0">
		...
		<!-- Add Modal HTML -->
		<?php include("html/modal_add_articulo.php");?>
		<!-- Edit Modal HTML -->
		<?php include("html/modal_edit_articulo.php");?>
		<!-- Delete Modal HTML -->
		<?php include("html/modal_delete_articulo.php");?>
		<!-- Add Rubro Modal HTML -->
		<?php include("html/modal_add_rubro.php");?>
		<!-- Add Subrubro Modal HTML -->
		<?php include("html/modal_add_subrubro.php");?>
