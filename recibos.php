...
<html>
	<head>
		...
		<title>Wallace - Mas que un bar | Recibos</title>
	...
	<body class="hold-transition sidebar-mini layout-fixed">
									...
									<?php
										if($user_type == "ADMIN"){
											echo '<li class="nav-item"><a href="./index.php" class="nav-link "><i class="fas fa-utensils"></i>&nbsp;&nbsp;<p>Mesas</p></a></li>
												...
												<li class="nav-item"><a href="./recibos.php" class="nav-link active"><i class="fas fa-dollar-sign"></i>&nbsp;&nbsp;<p>Recibos</p></a></li>
		...
		<!-- Info Modal HTML -->
		<?php include("html/modal_info_recibo.php");?>
		<!-- Cancel Modal HTML -->
		<?php include("html/modal_cancel_recibo.php");?>
		...
		<!-- Funciones -->
		<script src="js/scriptRecibos.js"></script>
		<!-- AdminLTE App -->
