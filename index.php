<?php
	...
	//TODO: redirect usertype CONCINA to comandas
?>
<!DOCTYPE html>
<html>
	<head>
		...
		<title>Wallace - Mas que un bar | Panel de control</title>
	...
	<body class="hold-transition sidebar-mini layout-fixed">
						...
						<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
							...
							<li class="nav-item has-treeview menu-open">
								...
								<ul class="nav nav-treeview">
									<?php
										if($user_type == "ADMIN"){
											echo '<li class="nav-item"><a href="./index.php" class="nav-link active"><i class="fas fa-utensils"></i>&nbsp;&nbsp;<p>Mesas</p></a></li>
			...
			<div class="content-wrapper">
				...
				<div class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<a href="index.php"><h1 class="m-0 text-dark">Mesas</h1></a>
							</div><!-- /.col -->
							<div class="col-sm-6">
				...
				<!--<div class="col-2">
					&nbsp;&nbsp;<a href="#comandaModal" class="btn btn-primary" data-toggle="modal">Generar comanda</a></br></br>
				</div>-->
		...
		<!-- Recipt Modal HTML -->
		<?php include("html/modal_recipt.php");?>
		<!-- Recipt Modal Mobile HTML -->
		<?php include("html/modal_recipt_mobile.php");?>
		<!-- Re Load Mesas Recipt Modal HTML -->
		<?php include("html/modal_reload_mesas.php");?>
		<!-- Comanda Modal HTML -->
		<?php include("html/modal_comanda.php");?>
		<!-- Change Modal HTML -->
		<?php include("html/modal_change.php");?>
		<!-- Logout Modal HTML -->
		...
		<script>
		/*var img_rubro = document.getElementById("id_img_rubro");
		img_rubro.addEventListener("click", function(event) {
