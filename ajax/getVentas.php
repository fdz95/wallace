				...
				if($result_select_ventas_fecha){
					...
					if ($numrows1 > 0){
						...
						<tr>
							...
							<td class='text-center'><?php echo $numrows1;?></td>
							<td class='text-center'>$ <?php echo $ingreso_total;?></td>
							<!--<td align="center" width="15%"><?php
								//echo "<a href='#' data-target='#infoVentasModal' class='info' data-toggle='modal' data-fecha='$fecha_mes_nombre $anio_actual'>Ver detalle</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
								//echo "<a href='#' onclick='descargarDetalleEstadistica($getFecha)'>Descargar</a>";
							?></td>-->
						</tr>
						<?php
					}
