...
<html>
	<head>
		...
		<title>Wallace - Mas que un bar | Clientes</title>
	...
	<body class="hold-transition sidebar-mini layout-fixed">
									...
									<?php
										if($user_type == "ADMIN"){
											echo '<li class="nav-item"><a href="./index.php" class="nav-link"><i class="fas fa-utensils"></i>&nbsp;&nbsp;<p>Mesas</p></a></li>
												<li class="nav-item"><a href="./clientes.php" class="nav-link active"><i class="fas fa-users"></i>&nbsp;&nbsp;<p>Control de clientes</p></a></li>
									...
									<div class="card">
										<div class="card-header">
											<div class="input-group mb-3">
												<a href="#addClienteModal" class="btn btn-info" data-toggle="modal"><b>+</b> Agregar cliente</a>
		...
		<!-- Edit Modal HTML -->
		<?php include("html/modal_edit_cliente.php");?>
		<!-- Delete Modal HTML -->
		<?php include("html/modal_delete_cliente.php");?>
		<!-- Info Modal HTML -->
		<?php include("html/modal_info_cliente.php");?>
