...
<html>
	<head>
		...
		<title>Wallace - Mas que un bar | Comandas</title>
	...
	<body class="hold-transition sidebar-mini layout-fixed">
									...
									<?php
										if($user_type == "ADMIN"){
											echo '<li class="nav-item"><a href="./index.php" class="nav-link"><i class="fas fa-utensils"></i>&nbsp;&nbsp;<p>Mesas</p></a></li>
												...
												<li class="nav-item"><a href="./comandas.php" class="nav-link active"><i class="fas fa-th-list"></i>&nbsp;&nbsp;<p>Comandas pendientes</p></a></li>
											...
											echo '<li class="nav-item"><a href="./comandas.php" class="nav-link active"><i class="fas fa-th-list"></i>&nbsp;&nbsp;<p>Comandas pendientes</p></a></li>
												<li class="nav-item"><a href="./comandasF.php" class="nav-link"><i class="fas fa-tasks"></i>&nbsp;&nbsp;<p>Comandas finalizadas</p></a></li>';
										}
									?>
								</ul>
			...
			<div class="content-wrapper">
				...
				<div class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1 class="m-0 text-dark">Comandas pendientes</h1>
							</div><!-- /.col -->
							<div class="col-sm-6">
								<ol class="breadcrumb float-sm-right">
									<li class="breadcrumb-item"><a href="#">Inicio</a></li>
									<li class="breadcrumb-item active">Comandas pendientes</li>
								</ol>
							</div><!-- /.col -->
						</div><!-- /.row -->
					</div><!-- /.container-fluid -->
				...
				<section class="content">
					<div class="container-fluid">
						<div class="row">
							<div class="col-12">
								<!-- Main content -->
								<div id="response_ok_comanda"></div>
								<div class='outer_div_ok_comanda'></div>
								<!-- /.card -->
							</div>
							<!-- /.col -->
						</div>
		...
		<!-- Ok Modal HTML -->
		<?php include("html/modal_ok_comanda.php");?>
		...
		<!-- Funciones -->
		<script src="js/scriptOkComanda.js"></script>
		<!-- AdminLTE App -->
