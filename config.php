<?php
	...
	if(isset($_SESSION['user_wallace'])){
		...
		if($result_select_config){
			...
			$cant_mesas = $columna['cant_mesas'];
			$precio_pool = $columna['precio_pool'];
			$precio_fichas = $columna['precio_fichas'];
		}
	}else{
...
<html>
	<head>
		...
		<title>Wallace - Mas que un bar | Configuracion</title>
	...
	<body class="hold-transition sidebar-mini layout-fixed">
									...
									<?php
										if($user_type == "ADMIN"){
											echo '<li class="nav-item"><a href="./index.php" class="nav-link"><i class="fas fa-utensils"></i>&nbsp;&nbsp;<p>Mesas</p></a></li>
												...
												<li class="nav-item"><a href="./config.php" class="nav-link active"><i class="fas fa-cog"></i>&nbsp;&nbsp;<p>Configuracion</p></a></li>';
										}
									?>
								</ul>
							</li>
								...
								<div class="col-12">
									<div class="card">
										<div class="card-header">
											<!-- Main content -->
											<div class="col-3">
												<form name="form_cfg_cant_mesas" id="form_cfg_cant_mesas">
													<div class="form-group">
														<label>Cantidad de mesas</label>
														<input type="number" name="config_cant_mesas" id="config_cant_mesas" placeholder="Cantidad" value="<?php echo $cant_mesas; ?>" class="form-control" />&nbsp;&nbsp;&nbsp;
														<span class="input-group-append">
															<input type="submit" class="btn btn-success" value="Guardar">&nbsp;&nbsp;&nbsp;
															<label id="response_cant_mesas"></label>
														</span>
											...
											<div class="col-3">
												<form name="form_cfg_precio_pool" id="form_cfg_precio_pool">
													<div class="form-group">
														<label>Mesas de Pool - Precio por minuto</label>
														<input type="number" name="config_precio_pool" id="config_precio_pool" placeholder="Precio" value="<?php echo $precio_pool; ?>" class="form-control" />&nbsp;&nbsp;&nbsp;
														<span class="input-group-append">
															<input type="submit" class="btn btn-success" value="Guardar">&nbsp;&nbsp;&nbsp;
															<label id="response_precio_pool"></label>
														</span>
													</div>
												</form>
											</div>
											...
											<div class="col-3">
												<form name="form_cfg_precio_fichas" id="form_cfg_precio_fichas">
													<div class="form-group">
														<label>Fichas - Precio</label>
														<input type="number" name="config_precio_fichas" id="config_precio_fichas" placeholder="Precio" value="<?php echo $precio_fichas; ?>" class="form-control" />&nbsp;&nbsp;&nbsp;
														<span class="input-group-append">
															<input type="submit" class="btn btn-success" value="Guardar">&nbsp;&nbsp;&nbsp;
															<label id="response_precio_fichas"></label>
														</span>
													</div>
												</form>
											</div>
		...
		<!-- Funciones -->
		<script src="js/scriptConfig.js"></script>
		<!-- AdminLTE App -->
