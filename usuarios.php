...
<html>
	<head>
		...
		<title>Wallace - Mas que un bar | Usuarios</title>
	...
	<body class="hold-transition sidebar-mini layout-fixed">
									...
									<?php
										if($user_type == "ADMIN"){
											echo '<li class="nav-item"><a href="./index.php" class="nav-link"><i class="fas fa-utensils"></i>&nbsp;&nbsp;<p>Mesas</p></a></li>
												...
												<li class="nav-item"><a href="./usuarios.php" class="nav-link active"><i class="fas fa-user"></i>&nbsp;&nbsp;<p>Usuarios</p></a></li>
									...
									<div class="card">
										<div class="card-header">
											<div class="input-group mb-3">
												<a href="#addUserModal" class="btn btn-info" data-toggle="modal"><b>+</b> Agregar usuario</a>
		...
		<!-- Add Modal HTML -->
		<?php include("html/modal_add_user.php");?>
		<!-- Edit Modal HTML -->
		<?php include("html/modal_edit_user.php");?>
		<!-- Delete Modal HTML -->
		<?php include("html/modal_delete_user.php");?>
		<!-- Info Modal HTML -->
		<?php include("html/modal_info_user.php");?>
